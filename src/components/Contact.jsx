...
const Contact = () => {
  ...
  <h1 className="flex justify-center mb-4 sm:mb-6 text-3xl sm:text-4xl md:text-5xl font-bold text-gradient-red-via-maroon-to-orange text-center hover:text-gradient-orange-via-red-to-maroon transition-all duration-500">{contactContent.heading}</h1>
