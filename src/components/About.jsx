    ...
    <div id="about" className="min-h-screen px-4 sm:px-8 md:px-16 lg:px-24 py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="flex flex-col-reverse md:flex-row-reverse lg:flex-col-reverse justify-between gap-8 lg:gap-12">
        <div className="flex flex-col gap-6 sm:gap-8 flex-1">
          ...
          <p className="text-sm sm:text-base md:text-lg w-full lg:w-full xl:w-[60%] text-justify leading-relaxed">I am an undergraduate student of Computer Science at IPB University with a strong interest in programming and creative fields, especially web development and graphic design. I consider myself a hardworking person with good time management skills. When I commit to something, I strive to achieve it to the best of my ability.</p>
        ...
        <div className="flex justify-center lg:justify-center flex-shrink-0">
          <img src={AboutImage} alt="About Me" className="w-64 sm:w-72 md:w-80 lg:w-96 h-auto object-cover rounded-lg" />
        </div>
      </div>
      <div className="flex flex-col justify-center gap-4 sm:gap-6 md:gap-4 mt-12 sm:mt-14 text-sm sm:text-base md:text-lg">
        <div className="flex flex-col gap-3 sm:gap-4 bg-gray-700/50 px-6 sm:px-8 md:px-10 lg:px-12 py-4 sm:py-5 md:py-6 rounded-xl">
          <div className="flex justify-between items-center">
            <img src={TotalProjects} alt="Total Projects" className="w-8 h-8 sm:w-10 sm:h-10" />
        ...
        <div className="flex flex-col gap-3 sm:gap-4 bg-gray-700/50 px-6 sm:px-8 md:px-10 lg:px-12 py-4 sm:py-5 md:py-6 rounded-xl">
          <div className="flex justify-between items-center">
            <img src={Certificate} alt="Certificates" className="w-8 h-8 sm:w-10 sm:h-10" />
        ...
        <div className="flex flex-col gap-3 sm:gap-4 bg-gray-700/50 px-6 sm:px-8 md:px-10 lg:px-12 py-4 sm:py-5 md:py-6 rounded-xl">
          <div className="flex justify-between items-center">
            <img src={Experiences} alt="Experiences" className="w-8 h-8 sm:w-10 sm:h-10" />
