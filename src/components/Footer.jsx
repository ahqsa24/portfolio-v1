          ...
          <div className="mx-auto w-full max-w-screen p-4 py-6 lg:py-8">
              <div className="md:flex md:justify-between">
                ...
                <div className="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2">
                    <div>
                        <h2 className="mb-6 text-lg font-bold text-gradient-red-via-maroon-to-orange hover:text-gradient-orange-via-red-to-maroon uppercase dark:text-white">Resources</h2>
                    ...
                    <div>
                        <h2 className="mb-6 text-lg font-bold text-gradient-red-via-maroon-to-orange hover:text-gradient-orange-via-red-to-maroon uppercase dark:text-white">Social Media</h2>
